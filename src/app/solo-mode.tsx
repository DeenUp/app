...
export default function Page(): ReactNode {
	...
	const styles = {
		screen: tw`flex flex-col items-stretch justify-between bg-primary`,
		body: tw`shadow-offset-x-10 shadow-offset-y-5 mx-6 mb-2 flex flex-grow flex-col items-stretch justify-around rounded-md bg-white p-12 shadow-md`,
		question: tw`text-left text-2xl font-bold`,
		options: tw`gap-6`,
